...
//     version 1.7.0
//     from Assets/Demo/Input/DemoCharacterInput.inputactions
//
...
{
    public partial class @DemoCharacterInput: IInputActionCollection2, IDisposable
    {
        public InputActionAsset asset { get; }
        public @DemoCharacterInput()
        {
            asset = InputActionAsset.FromJson(@"{
    ""name"": ""DemoCharacterInput"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ""controlSchemes"": [
        ...
        {
            private @DemoCharacterInput m_Wrapper;
            public PlayerActions(@DemoCharacterInput wrapper) { m_Wrapper = wrapper; }
